...
#Set Path variable to the folder containing your testing files
path = "D:\\My Files\\Documents\\TrackMa Testing\\"

fnlistpath = path + "files.xlsx"
outputpath = path + "output.xlsx"
summarypath = path + "summary.xlsx"
templatepath = path + "output_template.xlsx"

fnfile = openpyxl.load_workbook(fnlistpath)
outputfile = openpyxl.load_workbook(outputpath)
summaryfile = openpyxl.load_workbook(summarypath)
...
summaryfile.save("D:\\My Files\\Documents\\TrackMa Testing\\summary.xlsx")
outputfile.save("D:\\My Files\\Documents\\TrackMa Testing\\output.xlsx")